...
# install PyTorch
conda create -n denet -y python=3.10
...
pip install torch==2.0.1+cu117 torchvision==0.15.2+cu117 numpy==1.24.3 numba --extra-index-url https://download.pytorch.org/whl/cu117
